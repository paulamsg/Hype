...
import { getNotifications, deleteNotification, markNotificationRead, getUnreadCount, deleteAllNotifications, shareEventToFriend, respondToEvent } from '../controllers/notifications.controller'
...
router.post('/event-response', authMiddleware as RequestHandler, respondToEvent as unknown as RequestHandler)
